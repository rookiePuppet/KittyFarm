    ...
    */
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.backgroundColor({ "id": 16777227, "type": 10001, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" });
            Flex.displayPriority(this.DISPLAY_PRIORITY_TOW);
            Flex.flexGrow(this.FLEX_GROW_VALUE);
            Flex.height({ "id": 16777235, "type": 10002, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" });
            Flex.padding({ "id": 16777236, "type": 10002, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" });
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.width({ "id": 16777237, "type": 10002, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            __Common__.margin({ bottom: { "id": 16777234, "type": 10002, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" } });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777247, "type": 20000, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" });
            Image.height(24);
            Image.width(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.fontSize({ "id": 16777232, "type": 10002, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" });
            Text.width(this.FULL_PERCENT);
            Text.fontColor({ "id": 16777228, "type": 10001, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" });
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            ImageAnimator.images([
                { src: { "id": 16777241, "type": 20000, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" } },
                { src: { "id": 16777242, "type": 20000, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" } },
                { src: { "id": 16777243, "type": 20000, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" } },
                { src: { "id": 16777244, "type": 20000, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" } },
                { src: { "id": 16777245, "type": 20000, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" } },
            ]);
