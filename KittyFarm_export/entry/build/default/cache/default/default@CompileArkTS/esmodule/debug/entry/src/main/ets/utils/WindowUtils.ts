...
import { APP_KEY_XCOMPONENT_WIDTH, APP_KEY_XCOMPONENT_HEIGHT } from "@bundle:com.PuppetStudio.KittyFarm/entry/ets/common/Constants";
// These MUST be synchronized with ScreenManager.h
enum ScreenOrientation {
    kScreenOrientationUnknown = 0,
    kPortrait = 1,
    kPortraitUpsideDown = 2,
    kLandscapeLeft = 3,
    kLandscapeRight = 4,
    kAutoRotation = 5,
    kScreenOrientationCount = 6
}
;
