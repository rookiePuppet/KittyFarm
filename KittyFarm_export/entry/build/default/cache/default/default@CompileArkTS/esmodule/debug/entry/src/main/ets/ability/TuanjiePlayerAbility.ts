...
import { DisplayInfoManager } from "@bundle:com.PuppetStudio.KittyFarm/entry/ets/utils/DisplayInfoManager";
...
import { SetToGlobalThis } from "@bundle:com.PuppetStudio.KittyFarm/entry/ets/common/GlobalThisUtil";
...
export default class TuanjiePlayerAbility extends UIAbility {
    onCreate(want, launchParam): void {
        ...
        if (this.context.resourceManager.getNumber({ "id": 16777218, "type": 10007, params: [], "bundleName": "com.PuppetStudio.KittyFarm", "moduleName": "entry" })) {
